...
public class PrimitiveSerializeTest extends AbstractIOTest {
    ...
    public void testByte() throws IOException {
        assertEquals(1, serializer.serializeArray(out, data, getTemplate("../primitive/byte.js"), 1));
    ...
    public void testByteNull() throws IOException {
        ...
        assertEquals(1, serializer.serializeArray(out, singleMap, getTemplate("../primitive/byte.js"), 1));
    ...
    public void testShort() throws IOException {
        ...
        assertEquals(2, serializer.serializeArray(out, data, getTemplate("../primitive/short.js"), 1));
    ...
    public void testShortNull() throws IOException {
        ...
        assertEquals(2, serializer.serializeArray(out, singleMap, getTemplate("../primitive/short.js"), 1));
    ...
    public void testInt() throws IOException {
        ...
        assertEquals(4, serializer.serializeArray(out, data, getTemplate("../primitive/int.js"), 1));
    ...
    public void testIntNull() throws IOException {
        ...
        assertEquals(4, serializer.serializeArray(out, singleMap, getTemplate("../primitive/int.js"), 1));
    ...
    public void testLong() throws IOException {
        ...
        assertEquals(8, serializer.serializeArray(out, data, getTemplate("../primitive/long.js"), 1));
    ...
    public void testLongNull() throws IOException {
        ...
        assertEquals(8, serializer.serializeArray(out, singleMap, getTemplate("../primitive/long.js"), 1));
    ...
    public void testUnicodeString() throws IOException {
        ...
        assertEquals(2 + 2 * testUnicodeString.length(), serializer.serializeArray(out, data, getTemplate("../primitive/unicode-string.js"), 1));
    ...
    public void testDouble() throws IOException {
        ...
        assertEquals(8, serializer.serializeArray(out, data, getTemplate("../primitive/double.js"), 1));
    ...
    public void testDoubleNull() throws IOException {
        ...
        assertEquals(8, serializer.serializeArray(out, singleMap, getTemplate("../primitive/double.js"), 1));
    ...
    public void testBool1True() throws IOException {
        ...
        assertEquals(1, serializer.serializeArray(out, singleMap, getTemplate("../primitive/bool1.js"), 1));
    ...
    public void testBool2True() throws IOException {
        ...
        assertEquals(2, serializer.serializeArray(out, singleMap, getTemplate("../primitive/bool2.js"), 1));
    ...
    public void testBool4True() throws IOException {
        ...
        assertEquals(4, serializer.serializeArray(out, singleMap, getTemplate("../primitive/bool4.js"), 1));
    ...
    public void testBool8True() throws IOException {
        ...
        assertEquals(8, serializer.serializeArray(out, singleMap, getTemplate("../primitive/bool8.js"), 1));
    ...
    public void testByteArray() throws IOException {
        ...
        assertEquals(17, serializer.serializeArray(out, singleMap, getTemplate("../primitive/byte-array.js"),1));
