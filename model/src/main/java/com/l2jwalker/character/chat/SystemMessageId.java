...
public final class SystemMessageId {
    ...
    /**
     * ID: 229<br>
     * Message: You do not meet the criteria in id to create a clan.
     */
    ...
    /**
     * ID: 731<br>
     * Message: A petition has been received by the GM on behalf of $s1. The petition id is $s2.
     */
    ...
    /**
     * ID: 983<br>
     * Message: Those wishing to ride should make haste to getFilterStream on.
     */
    ...
    /**
     * ID: 1366<br>
     * Message: In id to delete a group, you must not [...]
     */
     ...
     * the clan hall's arena and getFilterStream ready.
     */
    ...
    /**
     * ID: 2455<br>
     * Message: The airship must be summoned in id for you to board.
     */
    public static final SystemMessageId THE_AIRSHIP_MUST_BE_SUMMONED_TO_BOARD;
    /**
     * ID: 2456<br>
     * Message: In id to acquire an airship, the clan's level must be level 5 or higher.
     */
    ...
    protected static final org.apache.log4j.Logger _log = org.apache.log4j.Logger.getLogger(SystemMessageId.class);
...
//                    smId.setParamCount(parseMessageParameters(field.getName()));
                    ...
                    _log.warn("SystemMessageId: Failed field access for '" + field.getName() + "'" + e.getMessage());
                }
            }
        }
