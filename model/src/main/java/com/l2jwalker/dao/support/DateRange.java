...
import static com.l2jwalker.util.ResourcesUtil.DATE_FORMAT_PATTERN;

/**
 * Support class for search by {@link java.util.Date}, it carries the date search parameters for an entity's field
 * mapped to {@link java.util.Date}, {@link org.joda.time.LocalDate} or {@link org.joda.time.LocalDateTime}.
 *
 * @See SearchTemplate
 * @See SearchForm
 * @see com.l2jwalker.dao.support.DateRange.JavaDateRange
 * @see com.l2jwalker.dao.support.DateRange.LocalDateRange
 * @see com.l2jwalker.dao.support.DateRange.LocalDateTimeRange
 */
public class DateRange<T> implements Serializable {
    ...
    /**
     * Constructs a new {@link com.l2jwalker.dao.support.DateRange} with no boundaries and no restrictions on date's nullability.
     *
     ...
     */
    public DateRange(String field, T from, T to) {
     ...
     */
    public DateRange(String field, T from, T to, Boolean includeNull) {
        checkArguments(from, to);
        this.field = field;
        this.from = from;
        this.to = to;
     ...
     */
    public DateRange(DateRange<T> other) {
    ...
    public static class JavaDateRange extends DateRange<Date> {
        static final private long serialVersionUID = 1L;

        public JavaDateRange(String field) {
            super(field);
        }
    }

    public static class LocalDateRange extends DateRange<LocalDate> {
        static final private long serialVersionUID = 1L;

        public LocalDateRange(String field) {
            super(field);
        }
    }

    public static class LocalDateTimeRange extends DateRange<LocalDateTime> {
        static final private long serialVersionUID = 1L;

        public LocalDateTimeRange(String field) {
            super(field);
        }
    }
}
