...
import com.l2jwalker.dao.support.OrderBy;
...
public abstract class HibernateUtil {
    public static final Example.PropertySelector NOT_NULL_OR_EMPTY = new NotNullOrEmptyPropertySelector();
    ...
    public static boolean isEntityIdManuallyAssigned(Class<?> type) {
        ...
        for (Field field : type.getDeclaredFields()) {
            if (isPrimaryKey(field)) {
                return isManuallyAssigned(field);
            }
        }
    ...
    private static boolean isManuallyAssigned(Field field) {
    ...
    private static List<String> getAttributesForPatternSearch(Class<?> type, String prefix) {
        List<String> columns = new FastList<String>();
        for (Method method : type.getMethods()) {
    ...
    /**
     * Helper method to apply on the passed {@link Criteria} the pagination and id by parameters found in the passed SearchTemplate.
     *
     * @return the same hibernate criteria with first, max results and id by properties set.
     */
    ...
    static final class NotNullOrEmptyPropertySelector implements Example.PropertySelector {
        ...
        public boolean include(Object object, String propertyName, Type type) {
            return object != null && !((object instanceof String) && "".equals(object));
        }
    }
}
